...
Scheduler.plugin(function (e) {
    e.templates.calendar_month = e.date.date_to_str("%F %Y"), e.templates.calendar_scale_date = e.date.date_to_str("%D"), e.templates.calendar_date = e.date.date_to_str("%d"), e.config.minicalendar = {mark_events: !0}, e._synced_minicalendars = [], e.renderCalendar = function (t, a, n) {
        var i = null, r = t.date || e._currentDate();
        if ("string" == typeof r && (r = this.templates.api_date(r)), a)i = this._render_calendar(a.parentNode, r, t, a), e.unmarkCalendar(i); else {
        ...
        var s = new Date(this._min_date), _ = new Date(this._max_date), c = new Date(e._date), u = r.month_day, h = this._ignores_detected;
        ...
        var m = p.querySelector(".dhx_year_month"), g = p.querySelector(".dhx_year_week"), f = p.querySelector(".dhx_year_body");
        if (m.innerHTML = this.templates.calendar_month(a), n.navigation)for (var b = function (t, a) {
        ...
        var M = p._min_date = this.date.week_start(a);
        p._max_date = this.date.add(p._min_date, 6, "week"), this._reset_month_scale(f, a, M, 6), i || t.appendChild(p), g.style.height = g.childNodes[0].offsetHeight - 1 + "px";
        var N = e.uid();
        e._waiAria.minicalHeader(m, N), e._waiAria.minicalGrid(p.querySelector(".dhx_year_grid"), N), e._waiAria.minicalRow(g);
        ...
        return e._waiAria.minicalHeader(m, N), this._cols = o, this._mode = d, this._colsS = l, this._min_date = s, this._max_date = _, e._date = c, r.month_day = u, this._ignores_detected = h,
            p
    ...
    }), e.templates.calendar_time = e.date.date_to_str("%d-%m-%Y"), e.form_blocks.calendar_time = {render: function (t) {
        var a = "<input class='dhx_readonly' type='text' readonly='true'>", n = e.config, i = this.date.date_part(e._currentDate()), r = 1440, o = 0;
        ...
        var d, l, s = t.getElementsByTagName("input"), _ = t.getElementsByTagName("select"), c = function (t, a, n) {
            t.onclick = function () {
                e.destroyCalendar(null, !0), e.renderCalendar({position: t, date: new Date(this._date), navigation: !0, handler: function (a) {
        ...
        if (e.config.full_day) {
            ...
            var h = t.previousSibling.getElementsByTagName("input")[0], p = 0 === e.date.time_part(n.start_date) && 0 === e.date.time_part(n.end_date);
            h.checked = p, _[0].disabled = h.checked,
                ...
                var i = d || n.start_date, o = l || n.end_date;
        ...
        r(s[0], n.start_date, 0), r(s[1], n.end_date, 1), c = function () {
        }, _[0].value = o(n.start_date), _[1].value = o(n.end_date)
        ...
        var n = function () {
            var n = e._date, i = new Date(n.valueOf());
        ...
        var a = e._date, n = e._mode, i = e.date.month_start(new Date(t._date)), r = e.date.add(i, 1, "month");
        if ("day" == n || this._props && this._props[n])i.valueOf() <= a.valueOf() && r > a && e.markCalendar(t, a, "dhx_calendar_click"); else if ("week" == n)for (var o = e.date.week_start(new Date(a.valueOf())), d = 0; 7 > d; d++)i.valueOf() <= o.valueOf() && r > o && e.markCalendar(t, o, "dhx_calendar_click"), o = e.date.add(o, 1, "day")
